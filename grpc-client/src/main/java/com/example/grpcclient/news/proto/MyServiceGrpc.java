...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageSingleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMessageSingle",
      requestType = com.example.grpcclient.news.proto.MyMemberRequest.class,
      responseType = com.example.grpcclient.news.proto.MyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageSingleMethod() {
    io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest, com.example.grpcclient.news.proto.MyResponse> getSendMessageSingleMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSendMessageSingleMethod = MyServiceGrpc.getSendMessageSingleMethod) == null) {
          MyServiceGrpc.getSendMessageSingleMethod = getSendMessageSingleMethod =
              io.grpc.MethodDescriptor.<com.example.grpcclient.news.proto.MyMemberRequest, com.example.grpcclient.news.proto.MyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendMessageSingle"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcclient.news.proto.MyMemberRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcclient.news.proto.MyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageServerMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageServerMethod() {
    io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest, com.example.grpcclient.news.proto.MyResponse> getSendMessageServerMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageClientMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageClientMethod() {
    io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest, com.example.grpcclient.news.proto.MyResponse> getSendMessageClientMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageBothMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest,
      com.example.grpcclient.news.proto.MyResponse> getSendMessageBothMethod() {
    io.grpc.MethodDescriptor<com.example.grpcclient.news.proto.MyMemberRequest, com.example.grpcclient.news.proto.MyResponse> getSendMessageBothMethod;
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessageSingle(com.example.grpcclient.news.proto.MyMemberRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendMessageSingleMethod(), responseObserver);
    }

    /**
     */
    public void sendMessageServer(com.example.grpcclient.news.proto.MyMemberRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyMemberRequest> sendMessageClient(
        io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyMemberRequest> sendMessageBoth(
        io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.grpcclient.news.proto.MyMemberRequest,
                com.example.grpcclient.news.proto.MyResponse>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpcclient.news.proto.MyResponse sendMessageSingle(com.example.grpcclient.news.proto.MyMemberRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.example.grpcclient.news.proto.MyResponse> sendMessageServer(
        com.example.grpcclient.news.proto.MyMemberRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcclient.news.proto.MyResponse> sendMessageSingle(
        com.example.grpcclient.news.proto.MyMemberRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE_SINGLE:
          serviceImpl.sendMessageSingle((com.example.grpcclient.news.proto.MyMemberRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse>) responseObserver);
          break;
        case METHODID_SEND_MESSAGE_SERVER:
          serviceImpl.sendMessageServer((com.example.grpcclient.news.proto.MyMemberRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcclient.news.proto.MyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpcclient.news.proto.NewsProto.getDescriptor();
    }
